...
class Game(object):
    def main(self, screen):
        ...
        learner = learning.Learning(self.matris, self.matris.lines, self.matris.current_tetromino, self.matris.matrix, MATRIX_WIDTH, MATRIX_HEIGHT)
        
        #self.matris.update(10)
        self.redraw()
        #learner.update(self.matris, self.matris.lines, self.matris.current_tetromino, self.matris.matrix)
        #time.sleep(10)
        ...
        while True:
        	try:
        		...
        		return
    def requestupdate():
        return self.matris.lines, self.matris.current_tetromino, self.matris.matrix, MATRIX_WIDTH, MATRIX_HEIGHT
